...
class CrewWidget extends StatelessWidget {
  int id;
  MediaType mediatype;
  CrewWidget({super.key, required this.id, required this.mediatype});
          ...
          provider.creditloading
              ...
              : AspectRatio(
                  ...
                  child: ListView.builder(
                      ...
                      shrinkWrap: true,
                      itemCount: provider.credits.crew?.length,
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                child: ClipOval(
                                  child: FadeInImage(
                                    ...
                                    image: NetworkImage(
                                        '${ApiConstants.imagePath}${provider.credits.crew?[index].profilePath}'),
                                    imageErrorBuilder:
                              ...
                              SizedBox(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        '${provider.credits.crew?[index].name}',
                                        style: GoogleFonts.salsa(fontSize: 15),
                                        textAlign: TextAlign.center,
                                      ),
                                      SizedBox(height: 5),
                                      Text(
                                        '${provider.credits.crew?[index].job}',
